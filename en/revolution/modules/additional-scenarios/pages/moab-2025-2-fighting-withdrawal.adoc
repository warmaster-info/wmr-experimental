...
image::moab-2025/fighting-withdrawal.svg[width=1440,height=960]
...
At the end of #each player's, or the defending player's?# turn, a single defending unit with all of its remaining stands within 10cm of a Withdrawal Zone is removed from the board. Any characters who have joined a unit that is removed leave with them.

Alternatively, if a character is within 10cm of an exit, they may be removed from the battlefield instead.

Each Withdrawal Zone can be used only once per turn.
...
_The campaign continues with xref:moab-2025-3-dawn-raid.adoc[]._
