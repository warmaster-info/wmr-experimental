...
points of strategic interest. The final positions of each force after the dust settles will decide the course of the battles to come.

image::moab-2025/take-and-hold.svg[width=1440,height=960]
...
placing four xref:moab.adoc#objective-points[Objective Points] starting with the
...
line on their *opponent’s* side of the battlefield.
...
* 1 Victory Point for controlling the Objective Point
  on their side of the table.
* 2 Victory Points for controlling the Objective Point
  in the centre of the table.
* 3 Victory Points for controlling the Objective Point
  on their opponent’s side of the table.
* Each player also earns an additional 1
  Victory Point if their general has joined a
  unit that controls an Objective Point.

_The campaign continues with xref:moab-2025-2-fighting-withdrawal.adoc[]_
