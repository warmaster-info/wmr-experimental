...
xref:armies:dark-elves.adoc#crossbowmen-and-dark-riders[Crossbowmen and Dark Riders]).
+
Cold One Chariots
cannot form brigades except with other units of Cold
One Chariots or Cold One Knights and _vice versa_.

[[cygor,†3]]3. Cygor:: The Cygor’s shooting attack uses the
xref:rules:artillery-and-machines.adoc#stone-thrower[Stone Thrower]
rules as described in the Rulebook.

[[pestigors,†4]]4. Pestigors:: One unit of Bestigors per full 1000 points
can be upgraded to Pestigors for 35 points.

[[weapon-teams,†5]]5. Weapon Teams:: Weapon Teams follow the same
rules for xref:armies:empire.adoc#skirmishers[Empire Skirmishers], but may only join
Clanrat units.
+
...
[[hellpit-abomination,†6]]6. Hellpit Abomination:: Hellpit Abominations are
...
[[verminlord,†7]]7. Verminlord:: Only Skaven Grey Seers can be
...
[[blood-knights,†8]]8. Blood Knights:: Blood Knights ignore the
...
[[varghulf,†9]]9. Varghulf:: Varghulfs never suffer the −1 Attack
